          ...
          var i = function (e, t) {
            ...
            for (var i = 0; i < r.length; i++) {
              if (r[i].type === "text") {
                ...
                var l = r[i].data;
                try {
                  katex.render(l, o, { displayMode: r[i].display });
                } catch (f) {
                  if (!(f instanceof katex.ParseError)) {
                    throw f;
                  }
                  console.error(
                  ...
                  n.appendChild(document.createTextNode(r[i].rawData));
                  continue;
                }
                n.appendChild(o);
              }
          ...
          var a = function (e, t, r, a) {
            ...
            for (var o = 0; o < e.length; o++) {
              if (e[o].type === "text") {
                ...
                if (s !== -1) {
                  d = s;
                  i.push({ type: "text", data: l.slice(0, d) });
                  f = false;
                }
                while (true) {
                  if (f) {
                    ...
                    i.push({ type: "text", data: l.slice(d, s) });
                    d = s;
                  } else {
                    s = n(r, l, d + t.length);
                    if (s === -1) {
                    ...
                    i.push({
                      type: "math",
                      data: l.slice(d + t.length, s),
                      rawData: l.slice(d, s + r.length),
                      display: a,
                    });
                    d = s + r.length;
                  }
                ...
                i.push({ type: "text", data: l.slice(d) });
              } else {
                i.push(e[o]);
              }
            }
