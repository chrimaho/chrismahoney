!(function (e) {
  ...
  function c(e, n, a) {
    ...
    function s(e) {
      ...
      u +=
        "<" + r(e) + Array.prototype.map.call(e.attributes, n).join("") + ">";
    }
    function c(e) {
      u += "</" + r(e) + ">";
    }
  ...
  function l(e, r, a, i) {
    ...
    function h(e, r) {
      ...
      if (a) {
        var i = x;
        i.rE || i.eE || (E += r), (M += g());
        do x.cN && (M += "</span>"), (B += x.r), (x = x.parent);
        while (x != a.parent);
        return (
          i.eE && (M += t(r)),
          (E = ""),
      ...
      if (d(r, x))
        throw new Error(
          'Illegal lexeme "' + r + '" for mode "' + (x.cN || "<unnamed>") + '"'
        );
    ...
    var k,
      ...
      C = {},
      M = "";
    for (k = x; k != y; k = k.parent) k.cN && (M = p(k.cN, "", !0) + M);
    var E = "",
      B = 0;
    try {
      for (var L, $, z = 0; ; ) {
        if (((x.t.lastIndex = z), (L = x.t.exec(r)), !L)) break;
        ($ = h(r.substr(z, L.index - z), L[0])), (z = L.index + $);
      }
      for (h(r.substr(z)), k = x; k.parent; k = k.parent)
        k.cN && (M += "</span>");
  ...
  function p(e) {
    var t = a(e);
    if (!/no(-?)highlight|plain|text/.test(t)) {
      var r;
      N.useBR
      ...
      (i.value = d(i.value)),
        (e.innerHTML = i.value),
        (e.className = b(e.className, t, i.language)),
  ...
  hljs.registerLanguage("coffeescript", function (e) {
    ...
    return {
      ...
      c: a.concat([
        ...
        { cN: "attribute", b: r + ":", e: ":", rB: !0, rE: !0, r: 0 },
      ]),
    };
  }),
      ...
      c: [
        ...
        { bK: "new throw return else", r: 0 },
        {
          ...
          c: [
            ...
            { cN: "params", b: /\(/, e: /\)/, k: t, r: 0, c: [e.CBCM] },
            e.CLCM,
            e.CBCM,
          ],
        },
    ...
    return {
      ...
      c: [
        ...
        },
        {
          ...
          c: [
            { cN: "keyword", b: /\S+/ },
            { b: /\s/, eW: !0, eE: !0, r: 0, c: [r, e.ASM, e.QSM, e.CSSNM] },
          ],
        },
        { cN: "tag", b: t, r: 0 },
        { cN: "rules", b: "{", e: "}", i: /\S/, r: 0, c: [e.CBCM, n] },
      ],
    };
  }),
  ...
  hljs.registerLanguage("json", function (e) {
    var t = { literal: "true false null" },
      ...
      i = { b: "\\[", e: "\\]", c: [e.inherit(n, { cN: null })], i: "\\S" };
    ...
    var t = {
      ...
      r = {
        ...
        c: [
          ...
          { cN: "url", b: "([a-z]+):/", e: "\\s", eW: !0, eE: !0, c: [t] },
          {
            cN: "regexp",
            c: [e.BE, t],
            v: [
  ...
  hljs.registerLanguage("php", function (e) {
    var t = { cN: "variable", b: "\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*" },
    ...
    return {
      ...
      c: [
        ...
        { b: /(::|->)+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/ },
        {
          ...
          c: [
            e.UTM,
            { cN: "params", b: "\\(", e: "\\)", c: ["self", t, e.CBCM, n, a] },
          ],
        },
        {
          cN: "class",
  ...
  hljs.registerLanguage("ruby", function (e) {
    var t =
      ...
      n = { cN: "yardoctag", b: "@[A-Za-z]+" },
      a = { cN: "value", b: "#<", e: ">" },
      i = [
        e.C("#", "$", { c: [n] }),
        e.C("^\\=begin", "^\\=end", { c: [n], r: 10 }),
        e.C("^__END__", "\\n$"),
      ],
      s = { cN: "subst", b: "#\\{", e: "}", k: r },
      c = {
